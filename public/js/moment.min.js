!(function (e, t) {
    ...
    function We(e, t) {
        ...
        var n = ((t % (n = 12)) + n) % n;
        return (
            (e += (t - n) / 12), 1 == n ? (he(e) ? 29 : 28) : 31 - ((n % 7) % 2)
        );
    }
    (S =
    ...
    function Ct(e) {
        ...
        (this._isValid = (function (e) {
            ...
            for (t in e)
                if (
                    c(e, t) &&
                    (-1 === S.call(Wt, t) || (null != e[t] && isNaN(e[t])))
                )
                    return !1;
            for (n = 0; n < i; ++n)
                if (e[Wt[n]]) {
