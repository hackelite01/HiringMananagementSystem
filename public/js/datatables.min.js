 ...
 *   https://datatables.net/download/#dt/dt-1.12.1/b-2.2.3/b-colvis-2.2.3/b-html5-2.2.3/b-print-2.2.3/date-1.1.2/fc-4.1.0/sl-1.4.0
 *
 * Included libraries:
 *  DataTables 1.12.1, Buttons 2.2.3, Column visibility 2.2.3, HTML5 export 2.2.3, Print view 2.2.3, DateTime 1.1.2, FixedColumns 4.1.0, Select 1.4.0
 */
...
(function (l) {
    ...
    u.ext = M = {
        ...
        classes: {},
        builder:
            "dt/dt-1.12.1/b-2.2.3/b-colvis-2.2.3/b-html5-2.2.3/b-print-2.2.3/date-1.1.2/fc-4.1.0/sl-1.4.0",
        errMode: "alert",
        feature: [],
        search: [],
...
(function (d) {
    ...
    d.extend(x.prototype, {
        ...
        _constructor: function () {
            ...
            d("body").on("keyup." + this.s.namespace, function (g) {
                if (!C.activeElement || C.activeElement === C.body) {
                    ...
                    -1 !== a.s.listenKeys.toLowerCase().indexOf(l) &&
                        a._keypress(l, g);
                }
            });
        },
        ...
        _expandButton: function (a, b, c, e, h, f, g) {
            ...
            for (var q = r.length; c < q; c++) {
                ...
                if (n)
                    if (
                        ((b = n.config !== p && n.config.split ? !0 : !1),
                        Array.isArray(n))
                    )
                        this._expandButton(
                            a,
                        ...
                        if (k) {
                            ...
                            k.conf.parent = g;
                            n.init &&
                                n.init.call(l.button(k.node), l, d(k.node), n);
                            m++;
                        }
                    }
            }
        ...
        _buildButton: function (a, b, c, e) {
            ...
            if (a.spacer) {
                var n = d("<span></span>")
                    .addClass(
                        "dt-button-spacer " + a.style + " " + h.spacerClass
                    )
                    .html(q(a.text));
                return {
                    conf: a,
        ...
        _resolveExtends: function (a) {
            var b = this,
                ...
                h = function (m) {
                    for (
                        var r = 0;
                        !d.isPlainObject(m) && !Array.isArray(m);
        ...
        _popover: function (a, b, c, e) {
            ...
            if (!1 === a) l();
                ...
                if ("absolute" === r) {
                    ...
                    if (
                        "button-right" === f.align ||
                        m.hasClass(f.rightAlignClassName)
                    )
    ...
    x.background = function (a, b, c, e) {
        ...
        a
            ? I(
                  d("<div/>").addClass(b).css("display", "none").insertAfter(e),
                  c
              )
            ...
            var c = [],
                ...
                h = function (l, m) {
                    ...
                    if (Array.isArray(l) || l instanceof d)
                        ...
                        m.s.buttons[l] &&
                            c.push({ inst: m, node: m.s.buttons[l].node });
                    else if ("string" === typeof l)
                        if (-1 !== l.indexOf(","))
                            for (
                                q = l.split(","), n = 0, r = q.length;
                                n < r;
                                n++
                            )
                                h(q[n].trim(), m);
                            ...
                            for (
                                l = l.replace(":name", ""), n = 0, r = q.length;
                                n < r;
                                n++
                            )
                                q[n].name === l &&
    ...
    d.extend(D, {
        collection: {
            ...
            action: function (a, b, c, e) {
                ...
                "keypress" === a.type &&
                    d("a, button", e._collection).eq(0).focus();
            },
        ...
        excel: function (a, b) {
            if (D.excelHtml5 && D.excelHtml5.available(a, b))
                return "excelHtml5";
        },
        pdf: function (a, b) {
    ...
    u.Api.register("buttons()", function (a, b) {
        ...
        var c = this.iterator(
            ...
            function (e) {
                if (e._buttons)
                    return x.buttonSelector(
                        x.instanceSelector(a, e._buttons),
                        b
                    );
            },
            !0
    ...
    u.Api.register("buttons.info()", function (a, b, c) {
        ...
        I(
            d('<div id="datatables_buttons_info" class="dt-button-info"/>')
                .html(a)
                .append(
                    d("<div/>")["string" === typeof b ? "html" : "append"](b)
                )
                .css("display", "none")
                .appendTo("body")
        );
...
(function (c) {
    "function" === typeof define && define.amd
        ? define(
              ["jquery", "datatables.net-dt", "datatables.net-buttons"],
              function (a) {
                  return c(a, window, document);
              }
          )
        ...
        ? (module.exports = function (a, b) {
              a || (a = window);
              (b && b.fn.dataTable) ||
                  (b = require("datatables.net-dt")(a, b).$);
        ...
        q = function (a, b) {
            ...
            c = d(
                '<div class="' +
                    ...
                    '-title"><div class="' +
                    b +
                    '-iconLeft"><button type="button" title="' +
                    c.previous +
                    '">' +
                    c.previous +
                    '</button></div><div class="' +
                    b +
                    '-iconRight"><button type="button" title="' +
                    c.next +
                    '">' +
                    c.next +
                    '</button></div><div class="' +
    ...
    d.extend(q.prototype, {
                ...
                if (g && g == f.luxon) {
                    ...
                    g
                        ...
                        : ((c = a.match(/(\d{4})\-(\d{2})\-(\d{2})/)),
                          (this.s.d = c
                              ? new Date(Date.UTC(c[1], c[2] - 1, c[3]))
                              : null));
            if (b || b === m)
        ...
        _constructor: function () {
            var a = this,
                ...
                k = function () {
                    ...
                    e !== c &&
                        (a.c.onChange.call(a, e, a.s.d, a.dom.input), (c = e));
                };
            ...
            d(l).on("i18n.dt", function (e, h) {
                h.oLanguage.datetime &&
                    (d.extend(!0, a.c.i18n, h.oLanguage.datetime),
                    a._optionsTitle());
            });
            ...
            this.dom.container
                .on("change", "select", function () {
                    var e = d(this),
                        h = e.val();
                    e.hasClass(b + "-month")
                        ? (a._correctMonth(a.s.display, h),
                          a._setTitle(),
                          a._setCalander())
                        : e.hasClass(b + "-year")
                        ? (a.s.display.setUTCFullYear(h),
                          a._setTitle(),
                          a._setCalander())
                    ...
                    if ("select" !== h)
                        if (
                            ...
                            if (e.hasClass("disabled") && !e.hasClass("range"))
                                ...
                                a.s.display.setUTCMonth(
                                    a.s.display.getUTCMonth() - 1
                                ),
                                    a._setTitle(),
                                    a._setCalander(),
                                    a.dom.input.focus();
        ...
        _hide: function (a) {
            if (a || "hidden" !== this.dom.input.attr("type"))
                (a = this.s.namespace),
                    ...
                    d("body").off("click." + a),
                    d(this.dom.input[0].offsetParent).off("." + a);
        },
        ...
        _show: function () {
            ...
            d(l).on("keydown." + b, function (k) {
                (9 !== k.keyCode && 27 !== k.keyCode && 13 !== k.keyCode) ||
                    a._hide();
            });
            setTimeout(function () {
        ...
        _writeOutput: function (a) {
            ...
            b &&
                (c =
                    g && g == f.luxon
                        ? g.DateTime.fromJSDate(this.s.d).toFormat(
                              this.c.format
                          )
                        : g
                        ? g
                              .utc(b, m, this.c.locale, this.c.strict)
...
var $jscomp$lookupPolyfilledValue = function (a, h) {
    ...
    if (null == k) return a[h];
    k = a[k];
    return void 0 !== k ? k : a[h];
};
$jscomp.polyfill = function (a, h, k, e) {
    h &&
        ($jscomp.ISOLATE_POLYFILLS
            ? $jscomp.polyfillIsolated(a, h, k, e)
            : $jscomp.polyfillUnisolated(a, h, k, e));
};
$jscomp.polyfillUnisolated = function (a, h, k, e) {
    k = $jscomp.global;
    a = a.split(".");
    ...
    function (a) {
        ...
        var k = 0,
            e = function (d) {
                ...
                return new h("jscomp_symbol_" + (d || "") + "_" + k++, d);
            };
        return e;
    },
    "es6",
    ...
    function (a) {
        ...
        var d = function (c, b) {
                ...
                "object" == f || "function" == f
                    ...
                    : (f = "p_" + b);
                var l = c.data_[f];
                if (l && $jscomp.owns(c.data_, f))
                    for (c = 0; c < l.length; c++) {
                        var u = l[c];
                        if ((b !== b && u.key !== u.key) || b === u.key)
                            return { id: f, list: l, index: c, entry: u };
                    }
...
(function () {
        ...
        k = (function () {
            function e(d, g) {
                ...
                if (!h || !h.versionCheck || !h.versionCheck("1.10.0"))
                    throw Error(
                        "StateRestore requires DataTables 1.10 or newer"
                    );
                d = new h.Api(d);
                this.classes = a.extend(!0, {}, e.classes);
                this.c = a.extend(!0, {}, e.defaults, g);
                (g && void 0 !== g.left) ||
                    void 0 === this.c.leftColumns ||
                    (this.c.left = this.c.leftColumns);
                (g && void 0 !== g.right) ||
                    void 0 === this.c.rightColumns ||
                ...
                if (this.s.dt.settings()[0]._bInitComplete)
                    ...
                    d.one("init.dt", function () {
                        m._addStyles();
                        m._setKeyTableListener();
                    });
                d.on("column-sizing.dt", function () {
                    return m._addStyles();
                });
            ...
            e.prototype._addStyles = function () {
                if (this.s.dt.settings()[0].oScroll.sY) {
                    var d = a(this.s.dt.table().node()).closest(
                            "div.dataTables_scrollBody"
                        )[0],
                        g = this.s.dt.settings()[0].oBrowser.barWidth;
                    this.s.barWidth =
                        d.offsetWidth - d.clientWidth >= g ? g : 0;
                    this.dom.rightTopBlocker.css("width", this.s.barWidth + 1);
                    this.dom.leftTopBlocker.css("width", this.s.barWidth + 1);
                    this.dom.rightBottomBlocker.css(
                        "width",
                        this.s.barWidth + 1
                    );
                    this.dom.leftBottomBlocker.css(
                        "width",
                        this.s.barWidth + 1
                    );
                }
                d = null;
                g = this.s.dt.column(0).header();
                var m = null;
                null !== g &&
                    ((g = a(g)),
                    (m = g.outerHeight() + 1),
                    (d = a(g.closest("div.dataTables_scroll")).css(
                        "position",
                        "relative"
                    )));
                ...
                null !== n &&
                    ...
                    (c = n.outerHeight()),
                    null === d &&
                        (d = a(n.closest("div.dataTables_scroll")).css(
                            "position",
                            "relative"
                        )));
                for (
                    var b = this.s.dt.columns().data().toArray().length,
                        f = 0,
                        l = 0,
                        u = a(this.s.dt.table().node())
                            .children("tbody")
                            .children("tr"),
                        x = 0,
                        A = new Map(),
                    ...
                    if (t.visible()) {
                        ...
                        if (r - x < this.c.left) {
                            ...
                            for (var v = 0, w = u; v < w.length; v++)
                                (p = w[v]),
                                    a(a(p).children()[r - x])
                                        .css(this._getCellCSS(!1, f, "left"))
                                        .addClass(this.classes.fixedLeft);
                            y.css(this._getCellCSS(!0, l, "left")).addClass(
                                this.classes.fixedLeft
                            );
                            t.css(this._getCellCSS(!0, l, "left")).addClass(
                                this.classes.fixedLeft
                            );
                        } else {
                            v = 0;
                            for (w = u; v < w.length; v++)
                                (p = w[v]),
                                    (p = a(a(p).children()[r - x])),
                                    p.hasClass(this.classes.fixedLeft) &&
                                        p
                                            .css(this._clearCellCSS("left"))
                                            .removeClass(
                                                this.classes.fixedLeft
                                            );
                            y.hasClass(this.classes.fixedLeft) &&
                                y
                                    .css(this._clearCellCSS("left"))
                                    .removeClass(this.classes.fixedLeft);
                            t.hasClass(this.classes.fixedLeft) &&
                                t
                                    .css(this._clearCellCSS("left"))
                                    .removeClass(this.classes.fixedLeft);
                        }
                ...
                null === g ||
                    g.hasClass("index") ||
                    (this.s.rtl
                        ? (this.dom.leftTopBlocker.outerHeight(m),
                          d.append(this.dom.leftTopBlocker))
                        : (this.dom.rightTopBlocker.outerHeight(m),
                          d.append(this.dom.rightTopBlocker)));
                null === n ||
                    n.hasClass("index") ||
                    (this.s.rtl
                        ? (this.dom.leftBottomBlocker.outerHeight(c),
                          d.append(this.dom.leftBottomBlocker))
                        : (this.dom.rightBottomBlocker.outerHeight(c),
                          d.append(this.dom.rightBottomBlocker)));
                v = l = f = 0;
                for (r = b - 1; 0 <= r; r--)
                    if (((t = this.s.dt.column(r)), t.visible()))
                        if (
                            ...
                            for (var z = u; q < z.length; q++)
                                (p = z[q]),
                                    a(a(p).children()[r - w])
                                        .css(this._getCellCSS(!1, f, "right"))
                                        .addClass(this.classes.fixedRight);
                            y.css(this._getCellCSS(!0, l, "right")).addClass(
                                this.classes.fixedRight
                            );
                            t.css(this._getCellCSS(!0, l, "right")).addClass(
                                this.classes.fixedRight
                            );
                        } else {
                            q = 0;
                            for (z = u; q < z.length; q++)
                                (p = z[q]),
                                    (p = a(a(p).children()[r - w])),
                                    p.hasClass(this.classes.fixedRight) &&
                                        p
                                            .css(this._clearCellCSS("right"))
                                            .removeClass(
                                                this.classes.fixedRight
                                            );
                            y.hasClass(this.classes.fixedRight) &&
                                y
                                    .css(this._clearCellCSS("right"))
                                    .removeClass(this.classes.fixedRight);
                            t.hasClass(this.classes.fixedRight) &&
                                t
                                    .css(this._clearCellCSS("right"))
                                    .removeClass(this.classes.fixedRight);
                        }
            ...
            e.prototype._getCellCSS = function (d, g, m) {
                return "left" === m
                    ? this.s.rtl
                        ? { position: "sticky", right: g + "px" }
                        : { left: g + "px", position: "sticky" }
                    : this.s.rtl
                    ? {
                          left: g + (d ? this.s.barWidth : 0) + "px",
                          position: "sticky",
                      }
                    : {
                          position: "sticky",
                          right: g + (d ? this.s.barWidth : 0) + "px",
                      };
            };
            ...
            e.prototype._setKeyTableListener = function () {
                var d = this;
                this.s.dt.on("key-focus", function (g, m, n) {
                    g = a(n.node()).offset();
                    m = a(
                        a(d.s.dt.table().node()).closest(
                            "div.dataTables_scrollBody"
                        )
                    );
                    if (0 < d.c.left) {
                        ...
                        g.left < b.left + f &&
                            ((c = m.scrollLeft()),
                            m.scrollLeft(c - (b.left + f - g.left)));
                    }
                    0 < d.c.right &&
                        ((c = d.s.dt.columns().data().toArray().length),
                        (n = a(n.node()).outerWidth()),
                        (b = a(d.s.dt.column(c - d.c.right).header()).offset()),
                        g.left + n > b.left &&
                            ((c = m.scrollLeft()),
                            m.scrollLeft(c - (b.left - (g.left + n)))));
                });
                ...
                this.s.dt.on("column-visibility", function (g, m, n, c, b) {
                    b &&
                        !m.bDestroying &&
                        setTimeout(function () {
                            d._addStyles();
    ...
    (function (e) {
        "function" === typeof define && define.amd
            ...
            : "object" === typeof exports
            ? (module.exports = function (d, g) {
                  d || (d = window);
                  (g && g.fn.dataTable) ||
                      (g = require("datatables.net")(d, g).$);
                  return e(g, d, d.document);
              })
        ...
        d("fixedColumns().left()", function (c) {
            ...
            return void 0 !== c
                ? (b._fixedColumns.left(c), this)
                : b._fixedColumns.left();
        });
        d("fixedColumns().right()", function (c) {
            var b = this.context[0];
            return void 0 !== c
                ? (b._fixedColumns.right(c), this)
                : b._fixedColumns.right();
        });
        e.fn.dataTable.ext.buttons.fixedColumns = {
            action: function (c, b, f, l) {
                e(f).attr("active")
                    ? (e(f).removeAttr("active").removeClass("active"),
                      b.fixedColumns().left(0),
                      b.fixedColumns().right(0))
                    : (e(f).attr("active", !0).addClass("active"),
                      b.fixedColumns().left(l.config.left),
                      b.fixedColumns().right(l.config.right));
            },
                ...
                c.button(b).text(
                    f.text ||
                        c.i18n(
                            ...
                            c.settings()[0]._fixedColumns.c.i18n.button
                        )
                );
            },
            text: null,
        };
        e(g).on("plugin-init.dt", function (c, b) {
            "dt" === c.namespace &&
                (b.oInit.fixedColumns || n.defaults.fixedColumns) &&
                (b._fixedColumns || m(b, null));
        });
    });
})();
...
(function (c) {
    "function" === typeof define && define.amd
        ? define(
              ["jquery", "datatables.net-dt", "datatables.net-fixedcolumns"],
              function (b) {
                  return c(b);
              }
          )
        ...
        ? (module.exports = function (b, a) {
              b || (b = window);
              (a && a.fn.dataTable) ||
                  (a = require("datatables.net-dt")(b, a).$);
              a.fn.dataTable.FixedColumns ||
                  require("datatables.net-fixedcolumns")(b, a);
              return c(a);
          })
        : c(jQuery);
})(function (c) {
    return c.fn.dataTable.fixedColumns;
});
...
(function (h) {
        ...
        b.on("mousedown.dtSelect", d, function (g) {
            ...
            .on("click.dtSelect", d, function (g) {
                ...
                if (e) {
                    ...
                    if (
                        (!k.anchorNode ||
                            h(k.anchorNode).closest("table")[0] ===
                                a.table().node()) &&
                        k !== e
                    )
                        return;
                ...
                var n = a
                    ...
                    .replace(/ +/g, ".");
                if (
                    h(g.target).closest("div." + n)[0] ==
                        a.table().container() &&
                    ((n = a.cell(h(g.target).closest("td, th"))), n.any())
                ) {
                    ...
                    q.isDefaultPrevented() ||
                        ((q = n.index()),
                        "row" === f
                            ? ((f = q.row), E(g, a, k, "row", f))
                            : "column" === f
                            ? ((f = n.index().column), E(g, a, k, "column", f))
                            : "cell" === f &&
                              ((f = n.index()), E(g, a, k, "cell", f)),
                ...
                var e = b
                    ...
                    g = b
                        ...
                        .map(function (f) {
                            ...
                            return k ? { row: k, column: f.column } : l;
                        })
                        .filter(function (f) {
                            return f !== l;
                        });
        ...
        if (!b._select) {
            var c = a.state.loaded(),
                d = function (t, G, p) {
                    if (null !== p && p.select !== l) {
                        a.rows({ selected: !0 }).any() && a.rows().deselect();
                        p.select.rows !== l && a.rows(p.select.rows).select();
                        a.columns({ selected: !0 }).any() &&
                            a.columns().deselect();
                        p.select.columns !== l &&
                            a.columns(p.select.columns).select();
                        a.cells({ selected: !0 }).any() && a.cells().deselect();
                        if (p.select.cells !== l)
                            for (t = 0; t < p.select.cells.length; t++)
                                a.cell(
                                    p.select.cells[t].row,
                                    p.select.cells[t].column
                                ).select();
                        a.state.save();
                    }
                };
            a.one("init", function () {
                a.on("stateSaveParams", function (t, G, p) {
                    ...
                    p.select.columns = a.columns({ selected: !0 })[0];
                    p.select.cells = a
                        .cells({ selected: !0 })[0]
                        .map(function (L) {
                            return {
            ...
            !0 === e
                ...
                ? ((f = e), (B = !0))
                : h.isPlainObject(e) &&
                  (e.blurable !== l && (k = e.blurable),
                  e.toggleable !== l && (n = e.toggleable),
                  e.info !== l && (q = e.info),
                  e.items !== l && (g = e.items),
                  (f = e.style !== l ? e.style : "os"),
                  (B = !0),
                  e.selector !== l && (y = e.selector),
                  e.className !== l && (M = e.className));
            a.select.selector(y);
            a.select.items(g);
            a.select.style(f);
            a.select.blurable(k);
            ...
            h.fn.dataTable.ext.order["select-checkbox"] = function (t, G) {
                return this.api()
                    .column(G, { order: "index" })
                    .nodes()
                    .map(function (p) {
                        return "row" === t._select.items
                            ? h(p).parent().hasClass(t._select.className)
                            : "cell" === t._select.items
                            ? h(p).hasClass(t._select.className)
                            : !1;
                    });
            };
            !B &&
                h(a.table().node()).hasClass("selectable") &&
                a.select.style("os");
        }
    };
    h.each(
        ...
        function (a, b) {
            m.ext.selector[b.type].push(function (c, d, e) {
                ...
                for (var f = 0, k = e.length; f < k; f++) {
                    var n = c[b.prop][e[f]];
                    ((!0 === d && !0 === n._select_selected) ||
                        (!1 === d && !n._select_selected)) &&
                        g.push(e[f]);
                }
                return g;
            });
    ...
    m.ext.selector.cell.push(function (a, b, c) {
        ...
        for (var e = 0, g = c.length; e < g; e++) {
            ...
            ((!0 === b &&
                ...
                !(
                    !1 !== b ||
                    (f._selected_cells && f._selected_cells[c[e].column])
                )) &&
                d.push(c[e]);
        }
        return d;
    ...
    v("column().selected()", function () {
        ...
        return a &&
            this.length &&
            a.aoColumns[this[0]] &&
            a.aoColumns[this[0]]._select_selected
            ? !0
            : !1;
    });
    ...
    v("cell().selected()", function () {
        ...
        return a &&
            this.length &&
            (a = a.aoData[this[0][0].row]) &&
            a._selected_cells &&
            a._selected_cells[this[0][0].column]
            ? !0
            : !1;
    });
...
(function (c) {
    "function" === typeof define && define.amd
        ? define(
              ["jquery", "datatables.net-dt", "datatables.net-select"],
              function (a) {
                  return c(a, window, document);
              }
          )
